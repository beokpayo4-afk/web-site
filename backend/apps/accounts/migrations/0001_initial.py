    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SUPER_ADMIN', 'Super Admin'), ('PRODUCT_MANAGER', 'Product Manager'), ('ORDER_MANAGER', 'Order Manager'), ('INVENTORY_MANAGER', 'Inventory Manager'), ('CUSTOMER_SUPPORT', 'Customer Support'), ('CUSTOMER', 'Customer')], db_index=True, default='CUSTOMER', max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_type', models.CharField(choices=[('SHIPPING', 'Shipping'), ('BILLING', 'Billing'), ('BOTH', 'Both')], default='BOTH', max_length=16)),
        ...
        migrations.AddIndex(
            model_name='address',
            index=models.Index(fields=['postal_code'], name='accounts_ad_postal__1984a7_idx'),
        ),
